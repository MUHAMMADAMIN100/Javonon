...
export class UpdateProgramDto {
  ...
  @IsOptional() @IsString() @MinLength(2) @MaxLength(100) @Matches(NO_HTML, { message: 'city содержит HTML-теги' }) city?: string;
  @IsOptional() @IsString() @MinLength(2) @MaxLength(200) @Matches(NO_HTML, { message: 'major содержит HTML-теги' }) major?: string;
