...
// Возвращаемый код тут не нужен — App позовёт эту же (идемпотентную)
// функцию из эффекта и заберёт мемоизированный результат, чтобы решить,
// скроллить ли к форме заявки.
